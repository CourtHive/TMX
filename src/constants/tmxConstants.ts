...
export const OFFICIALS_TAB = 'officials';
export const OFFICIALS_CONTROL = 'officialsControl';
export const TOURNAMENT_OFFICIALS = 'tournamentOfficials';
...
export const AVAILABILITY_GRID_CONTAINER = 'availabilityGridContainer';
